...
const ReviewCard = ({ name, role, rating, comment }) => {
  return (
    <div className="bg-white rounded-2xl shadow-md p-6 text-left transform transition-all hover:-translate-y-2 hover:shadow-xl hover:bg-blue-50">
...
const ReviewsSection = () => {
  ...
  useEffect(() => {
    ...
    setReviews([...defaultReviews, ...userReviews]); // merge once
  }, []);

  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold mb-4 text-gray-800">User Reviews</h2>
