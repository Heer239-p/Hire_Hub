...
const DeleteModel = ({ user, onClose, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center backdrop-blur-sm z-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-11/12 md:w-1/3">
        <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-100">Delete User</h2>
